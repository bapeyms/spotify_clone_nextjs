...
export default function Navbar() {
    ...
    return (
        <div className="relative w-full mb-2">
            ...
            <div className={`absolute top-16 left-0 w-full bg-[#061420BF] backdrop-blur-xl backdrop-filter border-b border-[#93E8FF]/30 rounded-b-lg px-4 py-5 flex flex-col gap-6 z-10 transition-all duration-300 md:hidden ${isOpen ? "opacity-100 translate-y-0 visible" : "opacity-0 -translate-y-4 invisible pointer-events-none"}`}>
