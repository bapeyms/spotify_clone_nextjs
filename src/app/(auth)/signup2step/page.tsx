...
export default function SignUP2() {
  ...
  useEffect(() => {
    const id = requestAnimationFrame(() => setProgress(targetProgress));
      ...
      >
        ...
        <div className="mt-2 w-full max-w-[400px] max-[768px]:max-w-none">
          <div className="h-1 overflow-hidden rounded-full bg-[#2A3C55]">
            <div
              className="h-full rounded-full bg-gradient-to-r from-[#37B6FF] to-[#6AD5FF] shadow-[0_0_10px_rgba(55,182,255,0.5)] transition-all duration-700 ease-out"
              style={{ width: `${progress}%` }}
            />
          </div>
        </div>

        <div className="mt-3 w-full max-w-[400px] max-[768px]:max-w-none">
          <label className="block text-base text-white">Ім&apos;я</label>
          ...
          <input
            ...
            className="mt-2 w-full rounded-xl border border-[#496999] bg-[#001B2E] px-4 py-2 text-base text-white outline-none placeholder:text-[#6B7FA8] max-[768px]:py-3"
          />
        ...
        <div className="mt-3 w-full max-w-[400px] max-[768px]:max-w-none">
          <label className="block text-base text-white">Дата народження</label>
          ...
          <button
            type="button"
            className="mt-0.5 text-xs text-[#8A8A8A] underline"
          >
            Докладніше
          </button>
          ...
          <div className="mt-3 flex gap-3">
            ...
            <select
              ...
              className="h-10 flex-1 rounded-xl border border-[#496999] bg-[#001B2E] px-3 text-white outline-none"
            >
            ...
            <input
              ...
              className="h-10 w-20 rounded-xl border border-[#496999] bg-[#001B2E] px-3 text-white outline-none placeholder:text-[#6B7FA8]"
            />
          </div>
        ...
        <div className="mt-3 w-full max-w-[400px] max-[768px]:max-w-none">
          <label className="block text-base text-white">Регіон проживання</label>
          ...
          <div className="mt-2 flex gap-3">
            <div className="flex-1">
              <label className="mb-1 block text-base text-white">Країна</label>
              <select
                value={country}
                onChange={(e) => setCountry(e.target.value)}
                className="w-full rounded-xl border border-[#496999] bg-[#001B2E] px-3 py-2 text-white outline-none"
              >
                <option value="" disabled>
                  Країна
                </option>
            ...
            <div className="flex-1">
              <label className="mb-1 block text-base text-white">Місто</label>
              <select
                value={city}
        ...
        <div className="mt-3 w-full max-w-[400px] max-[768px]:max-w-none">
          <p className="mb-2 text-base text-white">Хто ви?</p>
        ...
        <button
          type="submit"
          className="mt-4 mb-2 w-full max-w-[400px] rounded-xl bg-[#1DA1F2] px-4 py-2.5 text-lg font-bold text-black transition hover:bg-[#39b8ff] max-[768px]:max-w-none"
        >
          Зареєструватися
        </button>
      </div>
